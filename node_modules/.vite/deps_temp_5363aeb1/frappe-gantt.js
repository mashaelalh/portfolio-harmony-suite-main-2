...
var B = class {
  ...
  bind_bar_events() {
    ...
    if (p.on(this.$svg, "mousemove", ".bar-wrapper, .handle", (_) => {
      this.bar_being_dragged === false && Math.abs((_.offsetX || _.layerX) - l) > 10 && (this.bar_being_dragged = true);
    }), p.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (_, g) => {
      const c = p.closest(".bar-wrapper", g);
      g.classList.contains("left") ? (s = true, g.classList.add("visible")) : g.classList.contains("right") ? (r = true, g.classList.add("visible")) : g.classList.contains("bar-wrapper") && (t = true), this.popup && this.popup.hide(), e = _.offsetX || _.layerX, _.offsetY || _.layerY, a = c.getAttribute("data-id");
      let u;
      this.options.move_dependencies ? u = [
        a,
        ...this.get_all_dependent_tasks(a)
      ] : u = [a], o = u.map((y) => this.get_bar(y)), this.bar_being_dragged = false, l = e, o.forEach((y) => {
        const m = y.$bar;
      ...
      p.on(this.$container, "mousewheel", (g) => {
        ...
        if (!_ && g.currentTarget.scrollLeft <= c) {
          ...
          _ = true, this.gantt_start = d.add(
            this.gantt_start,
            -this.config.extend_by_units,
            this.config.unit
          ), this.setup_date_values(), this.render(), g.currentTarget.scrollLeft = u + this.config.column_width * this.config.extend_by_units, setTimeout(() => _ = false, 300);
        }
        if (!_ && g.currentTarget.scrollWidth - (g.currentTarget.scrollLeft + g.currentTarget.clientWidth) <= c) {
          let u = g.currentTarget.scrollLeft;
          _ = true, this.gantt_end = d.add(
            this.gantt_end,
            this.config.extend_by_units,
            this.config.unit
          ), this.setup_date_values(), this.render(), g.currentTarget.scrollLeft = u, setTimeout(() => _ = false, 300);
        }
      });
    }
    p.on(this.$container, "scroll", (_) => {
      ...
      var _, g, c;
      t = false, s = false, r = false, (c = (g = (_ = this.$container.querySelector(".visible")) == null ? void 0 : _.classList) == null ? void 0 : g.remove) == null || c.call(g, "visible");
  ...
  bind_bar_progress() {
    ...
    p.on(this.$svg, "mousedown", ".handle.progress", (o, h) => {
      e = true, t = o.offsetX || o.layerX, y_on_start = o.offsetY || o.layerY;
